/*
	2D Segment Tree
	Finding maximum/minimum number in a submatrix in O(logN*logM)
	where N*M is the size of the original matrix
	
	Source: http://stackoverflow.com/questions/25121878/2d-segment-quad-tree-explanation-with-c
*/
#include <bits/stdc++.h>
...
int st_size = MAX*MAX*4;	//size for segment tree
